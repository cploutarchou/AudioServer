...
!function (t) {
    ...
    return function t(e, s, i) {
        ...
        1: [function (t, e, s) {
            (function (t) {
                (function () {
                    ...
                    var i = e((function (t, e) {
                        t.exports = function () {
                            var t = "millisecond", e = "second", s = "minute", i = "hour", a = "day", n = "week",
                                r = "month", h = "quarter", o = "year", l = "date",
                                ...
                                u = {
                                    ...
                                    s: p, z: function (t) {
                                        ...
                                        var i = 12 * (s.year() - e.year()) + (s.month() - e.month()),
                                            a = e.clone().add(i, r), n = s - a < 0, h = e.clone().add(i + (n ? -1 : 1), r);
                            ...
                            var C = function () {
                                ...
                                return p.parse = function (t) {
                                    ...
                                    var d = this, c = !!w.u(h) || h, u = w.p(t), p = function (t, e) {
                                    ...
                                    switch (u) {
                                        ...
                                        case n:
                                            var v = this.$locale().weekStart || 0, C = (g < v ? g + 7 : g) - v;
                                    ...
                                    var d, c = w.p(n), u = "set" + (this.$u ? "UTC" : ""),
                                    ...
                                    var s = t || "YYYY-MM-DDTHH:mm:ssZ", i = w.z(this), a = this.$locale(), n = this.$H,
                                        r = this.$m, h = this.$M, o = a.weekdays, l = a.months,
                                        d = function (t, i, a, n) {
                                    ...
                                    var c, u = w.p(l), p = v(t), f = 6e4 * (p.utcOffset() - this.utcOffset()),
                                        g = this - p, m = w.m(this, p);
                        ...
                        t.exports = (s = {
                            ...
                            DD: [n, l("day")],
                            Do: [h, function (t) {
                                var e = o.ordinal, s = t.match(/\d+/);
                                if (this.day = s[0], e) for (var i = 1; i <= 31; i += 1) e(i).replace(/\[|\]/g, "") === t && (this.day = i)
                            }],
                            M: [r, l("month")],
                            MM: [n, l("month")],
                            MMM: [h, function (t) {
                                var e = c("months"), s = (c("monthsShort") || e.map((function (t) {
                                    return t.substr(0, 3)
                                }))).indexOf(t) + 1;
                            ...
                            try {
                                var n = function (t) {
                                        for (var e = (t = i(t, o && o.formats)).match(a), s = e.length, n = 0; n < s; n += 1) {
                                            var r = e[n], h = p[r], l = h && h[0], d = h && h[1];
                                        ...
                                        return function (t) {
                                            for (var i = {}, a = 0, n = 0; a < s; a += 1) {
                                                ...
                                                if ("string" == typeof r) n += r.length; else {
                                                    var h = r.regex, o = r.parser, l = t.substr(n), d = h.exec(l)[0];
                                    ...
                                    }(e)(t), r = n.year, h = n.month, l = n.day, d = n.hours, c = n.minutes, u = n.seconds,
                                    f = n.milliseconds, g = n.zone, m = new Date, b = l || (r || h ? 1 : m.getDate()),
                                    y = r || m.getFullYear(), v = 0;
                            ...
                            i.parse = function (t) {
                                var e = t.date, i = t.utc, n = t.args;
                                this.$u = i;
                                var r = n[1];
                                if ("string" == typeof r) {
                                    var h = !0 === n[2], l = !0 === n[3], d = h || l, c = n[2];
            ...
            }, r = (t, e, s) => a("li", {class: t, html: `<a href="#" data-page="${e}">${s}</a>`}), h = (t, e) => {
                let s, i;
                    ...
                    Promise.all(p).then((t => {
                        ...
                        Array.from(r).forEach((t => {
                            ...
                            a = n ? n(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i, parseFloat(a) == a ? l[c++] = {
                                value: Number(a),
                                row: t
                            } : o[d++] = {value: "string" == typeof i ? i.toLowerCase() : i, row: t}
                ...
                renderPager() {
                    if (n(this.pagers), this.totalPages > 1) {
                        ...
                        this.options.truncatePager && (n = ((t, e, s, i, n) => {
                            ...
                            for (let e = 1; e <= s; e++) if (1 == e || e == s || e >= o && e <= l) {
                                const s = t[e - 1];
